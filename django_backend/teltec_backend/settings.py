...
# Static files - use /tmp for writable paths in read-only containers (Nixpacks/Belmo)
_is_production = os.environ.get('DJANGO_ENV') == 'production'
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join('/tmp' if _is_production else str(BASE_DIR), 'staticfiles')
STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage'

# Media files
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join('/tmp' if _is_production else str(BASE_DIR), 'media')
